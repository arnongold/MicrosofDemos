...
namespace DynamicsCRMDemoPlugin.ContextComponents.Extensions
{
    ...
    {
        public static void Assign(this DataAccessContext pluginContext, EntityReference targetEntity, EntityReference assignee)
        {
        ...
        public static void Save(this DataAccessContext pluginContext, Entity targetEntity)
        {
            pluginContext.Context.UpdateObject(targetEntity);
            pluginContext.OrganizationService.Update(targetEntity);
        }

        public static string GetOptionsetText(this DataAccessContext pluginContext, Entity entity, IOrganizationService service, string optionsetName, int optionsetValue)
        {
